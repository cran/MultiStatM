...
#' @return The list of partition matrices with blocks containing two elements.
#' The list is empty if \code{N} is odd.
#' @examples
#' PA<-Partition_Pairs(4)
# 'PAp<-Partition_Pairs(5)
...
#'
#' @param pU A partition matrix. For instance a matrix generated by Partition_Type_All.
#' @return \code{perm_pU} A vector with the elements \code{1} to \code{N} permuted according to \code{pU}.
...
#' @return \code{IndecompK2L} A list of partition matrices
#' indecomposable with respect to L
#' @return \code{numb_by_sizes} A vector indicating the number of indecomposable partitions
...
#' Closed Diagrams without Loops
#' 
#' Given a partition L looks for those partitions  \code{K}  of pairs which are 
#' indecomposable in accordance with L, (L, \code{K}) represent diagrams.
#' It is used for getting higher order cumulants of Hermite polynomials defined by  L, 
#' see Terdik (2021) Proposition 4.3, p.194.
#' 
#' 
#' @param L a partition matrix
#' 
#' @return The list of partition matrices indecomposable with respect to L
#'
#' @references Gy. Terdik, Multivariate statistical methods - going beyond the linear,
#' Springer 2021. Section 1.4.8.1
