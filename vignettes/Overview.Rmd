...
+------------------------+-----------------------------+---------------+
|Esti_Gram_Charlier      | GramCharlier                | Estimation    |
+------------------------+-----------------------------+---------------+
...
+------------------------+-----------------------------+---------------+
| indx_UnivMomCum        | MargMomCum                  | Commutators   |
+------------------------+-----------------------------+---------------+
...
`MargMomCum` and `EliminIndx`. The former provides a vector
...
matrices. See examples 4 and 6 below for the use of `MargMomCum`
and `EliminIndx`.
